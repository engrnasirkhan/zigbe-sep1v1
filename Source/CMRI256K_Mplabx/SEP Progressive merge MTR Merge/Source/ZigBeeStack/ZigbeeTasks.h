...
#define FRAME_BEACON        0x00
#define FRAME_DATA          0x01
#define FRAME_ACK           0x02
#define FRAME_MAC_COMMAND   0x03

#define FRAME_NWK_COMMAND   0x01
#define FRAME_NWK_DATA      0x00
...
typedef struct _APP_NOTIFICATION
{
    SHORT_ADDR current_ADDR;
    PAN_ADDR current_PANID;
    BYTE currentChannel;
} APP_NOTIFICATION;

#if defined(__C32__)

/* PIC32 uses different data packing compared to 8, 16-bit microcontrollers */
/* PARAMS data packing is different for PIC32 microcontroller compared to PIC18, PIC24 */
...
typedef union _PARAMS
{
    ...
    struct __attribute__((packed,aligned(1))) _PD_DATA_indication
    {
        BYTE    psduLength;
        BYTE    filler1[26];
...
//    } PLME_ED_request;
    ...
    struct __attribute__((packed,aligned(1))) _MCPS_DATA_indication
    {
    ...
    struct __attribute__((packed,aligned(1))) _MLME_BEACON_NOTIFY_indication
    {
...
//        } PendAddrSpec;
    ...
    struct _MLME_ASSOCIATE_indication
    {
        ...
        BYTE                        filler2[10];
        BYTE                        ACLEntry;
        BYTE                        mpduLinkQuality; // Must overlay MCPS_DATA_indication
    ...
    struct _NLME_ROUTE_DISCOVERY_confirm     // For ZigBee 2006
    {
        ...
        BYTE        filler2;
    #if I_SUPPORT_CONCENTRATOR == 1
        BYTE        NetworkStatusCode;
    #endif
    } NLME_ROUTE_DISCOVERY_confirm;

    struct __attribute__((packed,aligned(1))) _NLDE_DATA_indication
    {
    ...
    struct _NLME_NWK_STATUS_indication
    {
        BYTE                        nwkStatusCode;
        SHORT_ADDR                  ShortAddress;
    } NLME_NWK_STATUS_indication;
    ...
    struct _APP_LEAVE_indication
    {
        BOOL                        Rejoin;         // yfy added for 2006
        BYTE                        filler1;
        BYTE                        filler2[6];
        LONG_ADDR                   DeviceAddress;  // Must overlay MLME_DISASSOCIATE_indication and MCPS_DATA_indication.SrcAddr
    } APP_LEAVE_indication;
    ...
    struct __attribute__((packed,aligned(1))) _APSDE_DATA_indication
    {
        BYTE        asduLength;
        BYTE        SecurityStatus;
        BYTE        filler[2];
    ...
    struct _APSME_TRANSPORT_KEY_request
    {
        ...
        BYTE        _UseNwkSecurity:4;
        BYTE        _UseAPSSecurity:4;
...
//              BYTE    UseParent;
    ...
    {
        BYTE        KeyType;
        BYTE        filler1[15]; // previous 7.
        LONG_ADDR   SrcAddress; // Must overlay for TRANSPORT_KEY_request
        //BYTE        filler2[8];
        LONG_ADDR   PartnerAddress;
        SHORT_ADDR  SrcShortAddress;
    ...
    struct __attribute__((packed,aligned(1))) _ZDO_DATA_indication     // Must match APSDE_DATA_indication
    {
        BYTE        asduLength;
        BYTE        SecurityStatus;
        BYTE        filler[2];
    ...
    struct _APP_START_DEVICE_req
    {
        BOOL mode;
    } APP_START_DEVICE_req;

    struct _APP_START_DEVICE_conf
    {
        BYTE                        Status;
        SHORT_ADDR                  ShortAddress;
        PAN_ADDR                    PANId;
        ...
        struct _APP_MGMT_NWK_UPDATE_NOTIFY
        {
            ...
            BYTE                        EnergyValues[16];
        } APP_MGMT_NWK_UPDATE_NOTIFY;
    #endif
#endif
//TODO: Alignment needs to be checked
    struct _INTRP_DATA_req
    {
        BYTE        ASDULength;
        BYTE        filler1[1];
        SHORT_ADDR  ProfileId;
        SHORT_ADDR  ClusterId;
        BYTE        SrcAddrMode;
        BYTE        DstAddrMode;
        BYTE        filler2[8];
        ADDR        DstAddress;
    ...
    struct _INTRP_DATA_conf
    {
        BYTE Status;
        BYTE ASDUHandle;
    } INTRP_DATA_conf;

    struct __attribute__((packed,aligned(1))) _INTRP_DATA_indication
    {
        BYTE ASDULength;
        BYTE filler1[3];
        PAN_ADDR SrcPANId;
...
typedef enum _ZIGBEE_PRIMITIVE
{
    ...
    NLME_SYNC_LOSS_indication,               //0x4e
    ...
    NLME_ROUTE_DISCOVERY_confirm,
    NLME_NWK_STATUS_indication,
    APP_START_DEVICE_request,
    APP_START_DEVICE_confirm,
    APP_NETWORK_DISCOVERY_confirm,
    APP_MGMT_NWK_UPDATE_NOTIFY,
    APP_LEAVE_indication,
    INTRP_DATA_request,
    INTRP_DATA_confirm,
...
//	        #endif
            ...
            //#endif
//			#if defined(MERGED_STACK) || !defined (I_AM_COORDINATOR)
                BYTE bTriggerDeviceAnnce        : 1;
                BYTE rejoin                     : 1;
//            #endif
            #if I_SUPPORT_CONCENTRATOR == 1
                BYTE bTransmitManyToOneRouting  : 1;
            #endif
            //#ifdef I_AM_RFD
                BYTE    bLostSyncWithParent     : 1;
            //#endif
            BYTE    bActiveScanToRejoin     : 1;
        } bits;
    } flags;
} ZIGBEE_STATUS;
